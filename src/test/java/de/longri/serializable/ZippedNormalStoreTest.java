 ...
 */
public class ZippedNormalStoreTest {
    ...
    public void testBooleanObject() throws Exception {
        ...
        obj2.deserialize(new ZippedNormalStore(writer.getArray()));
        System.out.println("ZippedNormalStore-Boolean: " + writer.getArray().length + " Bytes!");
    ...
    public void testByteObject() throws Exception {
        ...
        obj.serialize(writer);
        obj2.deserialize(new ZippedNormalStore(writer.getArray()));
        System.out.println("ZippedNormalStore-Byte: " + writer.getArray().length + " Bytes!");
        assertEquals(obj, obj2);
    }
    ...
    public void testShortObject() throws Exception {
        ...
        obj.serialize(writer);
        obj2.deserialize(new ZippedNormalStore(writer.getArray()));
        System.out.println("ZippedNormalStore-Short: " + writer.getArray().length + " Bytes!");
        assertEquals(obj, obj2);
    }
    ...
    public void testIntegerObject() throws Exception {
        ...
        obj.serialize(writer);
        obj2.deserialize(new ZippedNormalStore(writer.getArray()));
        System.out.println("ZippedNormalStore-Integer: " + writer.getArray().length + " Bytes!");
        assertEquals(obj, obj2);
    }
    ...
    public void testLongObject() throws Exception {
        ...
        obj.serialize(writer);
        obj2.deserialize(new ZippedNormalStore(writer.getArray()));
        System.out.println("ZippedNormalStore-Long: " + writer.getArray().length + " Bytes!");
        assertEquals(obj, obj2);
    }
    ...
    public void testString() throws Exception {
        ...
        System.out.println("ZippedNormalStore-String: " + writer.getArray().length + " Bytes!");
